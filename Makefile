limited: $(TARGETLIM)
	...
	clang++  -I./src -Wall -Werror -g -D DISPLAY_MAX_T=1000  -c -o src/ShortestRemainingTime.o src/ShortestRemainingTime.cpp
	clang++  -I./src -Wall -Werror -g -D DISPLAY_MAX_T=1000  -c -o src/SeqGenerator.o src/SeqGenerator.cpp
	clang++  ./src/main.o ./src/Process.o ./src/RoundRobin.o ./src/ShortestRemainingTime.o ./src/SeqGenerator.o -o limited.out
...
full: $(TARGETFULL)
	...
	clang++  -I./src -Wall -Werror -g -c -o src/ShortestRemainingTime.o src/ShortestRemainingTime.cpp
	clang++  -I./src -Wall -Werror -g -c -o src/SeqGenerator.o src/SeqGenerator.cpp
	clang++  ./src/main.o ./src/Process.o ./src/RoundRobin.o ./src/ShortestRemainingTime.o ./src/SeqGenerator.o -o full.out
